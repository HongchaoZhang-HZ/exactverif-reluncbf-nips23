...
############################################
D_H = 128 # the number of neurons of each hidden layer
...
############################################
ALPHA = 0.01 # initial learning rate ##0.01
...
# for plotting
############################################
PLOT_EXP_B = np.array([5, 5, 5]) # sampling from domain for plotting the boundary of barrier using contour plot
...
PLOT_EXP_V = np.array([5, 5, 5]) # sampling from domain for plotting the vector field
PLOT_LEN_V = np.power(2, PLOT_EXP_V) # the number of samples for each dimension of domain, usually equal to superp.DATA_LEN_D

PLOT_EXP_P = np.array([5, 5, 5]) # sampling from domain for plotting the scattering sampling points, should be equal to superp.DATA_LEN_D
